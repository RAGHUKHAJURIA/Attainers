...
const BlogsPage = () => {
    ...
    const fetchBlogs = async () => {
        try {
            const response = await fetch('https://attainers.vercel.app/api/public/blogs');
            if (response.ok) {
    ...
    const handleAddBlog = async (newBlog) => {
        try {
            ...
            const response = await fetch('https://attainers.vercel.app/api/admin/blogs', {
                method: 'POST',
                headers: {
    ...
    const handleDelete = async (id) => {
        ...
        try {
            const token = await getToken();
            const response = await fetch(`https://attainers.vercel.app/api/admin/blogs/${id}`, {
                method: 'DELETE',
                headers: {
                    'Authorization': `Bearer ${token}`
                }
