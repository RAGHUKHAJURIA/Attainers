                ...
                <div className="inline-block align-bottom bg-white rounded-3xl text-left overflow-hidden shadow-2xl transform transition-all sm:my-8 sm:align-middle sm:max-w-lg sm:w-full relative z-10 border border-gray-100 animate-scaleIn">
                    <div className="bg-white px-6 pt-6 pb-6 sm:p-8">
                        <div className="flex items-center justify-between mb-6">
                            <h3 className="text-2xl font-bold text-gray-900">Add New Exam</h3>
                            <button
                                type="button"
                                onClick={onClose}
                        ...
                        <form onSubmit={handleSubmit} className="space-y-5">
                            ...
                            <div className="mt-6 flex flex-col-reverse sm:flex-row sm:justify-end gap-3">
                                ...
                                <button
                                    type="submit"
                                    className="w-full sm:w-auto px-6 py-3 bg-gradient-to-r from-red-600 to-pink-600 text-white rounded-2xl font-bold text-base shadow-lg shadow-red-600/30 hover:shadow-red-600/50 hover:-translate-y-0.5 transition-all duration-300"
                                >
                                    Add Exam
                                </button>
                            </div>
