        ...
        <section className="relative w-full min-h-[85vh] bg-white overflow-hidden flex flex-col items-center justify-center pt-20 pb-16">
            ...
            <div className="relative z-10 text-center max-w-4xl mx-auto px-4 mt-8">
                ...
                <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
                    <Link to="/courses" className="px-8 py-4 bg-blue-600 text-white rounded-2xl font-bold text-lg shadow-lg shadow-blue-600/30 hover:shadow-blue-600/50 hover:-translate-y-1 transition-all duration-300">
                        Start Learning Free
                    </Link>
                    <Link to="/youtube" className="px-8 py-4 bg-white text-gray-700 border border-gray-200 rounded-2xl font-bold text-lg hover:bg-gray-50 transition-all duration-300 flex items-center gap-2">
                ...
                <div className="absolute top-20 right-20 transform rotate-3 transition-transform hover:rotate-6 duration-300 pointer-events-auto">
                    <div className="w-64 bg-white rounded-3xl shadow-2xl p-6 border border-gray-200">
                        ...
                        <div className="flex justify-between items-center gap-4">
                            {/* YouTube */}
                            <a href="https://youtube.com" target="_blank" rel="noopener noreferrer" className="flex flex-col items-center gap-2 group cursor-pointer">
                            ...
                            {/* X / Twitter */}
                            <a href="https://x.com" target="_blank" rel="noopener noreferrer" className="flex flex-col items-center gap-2 group cursor-pointer">
