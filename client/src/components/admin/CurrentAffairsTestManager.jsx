...
const CurrentAffairsTestManager = () => {
    ...
    const fetchTests = async () => {
        ...
        try {
            ...
            if (response.ok) {
                ...
                // Filter only current affairs tests
        ...
        return (
            <div>
                ...
                <MockTestForm
                    ...
                    defaultTestType="current-affairs"
                />
            </div>
        );
    }
    ...
    return (
        <div className="space-y-6">
            <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4 bg-white p-4 sm:p-6 rounded-xl shadow-sm border border-gray-100">
                <div>
                    <h2 className="text-xl sm:text-2xl font-bold text-gray-800">J & K Current Affairs Tests</h2>
                    <p className="text-sm text-gray-600 mt-1">Manage mock tests for J & K Current Affairs section</p>
                </div>
                <button
...
export default CurrentAffairsTestManager;
